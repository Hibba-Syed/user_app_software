...
class UserCitySelectScreenState extends State<UserCitySelectScreen> {
  ...
  Future<void> updateCountryCityApiCall() async {
    ...
    await updateCountryCity(countryId: selectedCountry, cityId: selectedCity)
      ...
      if (widget.isBack) {
        ...
        if (getStringAsync(USER_TYPE) == CLIENT || getStringAsync(USER_TYPE) == CORPORATE ) {
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              title: Text(Cities[index],
                                  style: selectedCity == CitiesId[index]
                                      ? boldTextStyle(
                                      color: colorPrimary)
                                      : primaryTextStyle()
                              ),
                              trailing: selectedCity ==CitiesId[index]
  ...
  addToSP(String value) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString('currentCity', value);
  }
}
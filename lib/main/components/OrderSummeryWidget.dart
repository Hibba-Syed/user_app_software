    ...
    return Column(
      ...
      children: [
       ...
       // if (widget.onAnotherCharges != 0)
         ...
         if( widget.onAnotherCharges != null && widget.onAnotherCharges != 0) ...[
          8.height,
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                        '(${(widget.totalDistance).toStringAsFixed(digitAfterDecimal)}',
            ...
            Row(
              children: [
                ...
                Row(
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    Text('(${widget.totalWeight}', style: secondaryTextStyle()),
                    Icon(Icons.close, color: Colors.grey, size: 12),
        ...
        Align(
          ...
          child: Column(
            children: [
              8.height,
              Text(
                  '${printAmount((fixedCharges + widget.distanceCharge + widget.weightCharge).toStringAsFixed(digitAfterDecimal).toDouble())}',
                  style: primaryTextStyle()),
            ],
          ),
            ...
            Column(
              ...
              return Padding(
                ...
                child: Row(
                  children: [
                    Text(
                        mData.key!.replaceAll("_", " ").capitalizeFirstLetter(),
                        style: primaryTextStyle()),
                    4.width,
        ...
        Row(
          ...
          children: [
            ...
            16.width,
            // widget.onAnotherCharges == 0 ? Text('${printAmount(widget.totalAmount)}', style: boldTextStyle(size: 20)) : Text('${printAmount(widget.totalAmount + widget.onAnotherCharges)}', style: boldTextStyle(size: 20)),
            ...
            (widget.status.validate() == ORDER_CANCELLED &&
                ...
                ? Row(
                    ...
                    children: [
                      ...
                      8.width,
                      Text(
                          '${printAmount(widget.payment!.cancelCharges.validate())}',

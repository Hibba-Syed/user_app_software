...
class OrderData {
  ...
  OrderData.fromJson(Map<String, dynamic> json) {
    ...
    pickupPoint = json['pickup_point'] != null
        ...
        : null;
    deliveryPoint = json['selected_delivery_point'] != null
        ? new PickupPoint.fromJson(json['selected_delivery_point'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.deliveryPoint != null) {
      data['selected_delivery_point'] = this.deliveryPoint!.toJson();
    ...
    data['delivery_point'] = this.deliveryPointsList;
    data['charge_per_address'] = this.chargePerAddress;
    data['carry_packages_charge'] = this.carryPackagesCharge;
    data['courier_will_carry'] = this.courierWillCarry;
    data['delivery_receiver_name'] = this.deliveryReceiverName;
    return data;
  }
}

...
import '../../main/screens/AllCreditCard.dart';
import '../../main/screens/AllDriverInvoices.dart';
            ...
            child: Column(
              children: [
                ...
                ListView(
                  ...
                  children: [
                    settingItemWidget(
                        Icons.person_outline, language.editProfile, () {
                      EditProfileScreen().launch(context);
                    }),
                    settingItemWidget(
                        Icons.assignment_outlined, language.verifyDocument, () {
                      VerifyDeliveryPersonScreen().launch(context);
                        ...
                        suffixIcon: getBoolAsync(IS_VERIFIED_DELIVERY_MAN)
                            ...
                            : null),
                    settingItemWidget(
                        Icons.add_card_outlined, language.earningHistory, () {
                    ...
                    settingItemWidget(
                        Icons.lock_outline, language.changePassword, () {
                      ChangePasswordScreen().launch(context);
                    }),
                    settingItemWidget(Icons.data_array, "Your Invoice", () {
                      AllDriverInvoices().launch(context);
                    }),
                    settingItemWidget(Icons.credit_card, "Credit Card", () {
                      AllCreditCard().launch(context);
                    }),
                    settingItemWidget(
                        Icons.location_on_outlined, language.changeLocation,
                        () {
                    ...
                    settingItemWidget(
                        Icons.delete_forever, language.deleteAccount, () {

                    ...
                    children: orderList.map((item) {
                      return item.status != ORDER_DRAFT
                          ? GestureDetector(
                                        ...
                                        if (item.pickupDatetime != null)
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              4.height,
                                              Text(
                                                  '${language.at} ${printDate(item.pickupDatetime!)}',
                                                  style: secondaryTextStyle()),
                                              16.height,
                                            ],
                                          ),
                                          ...
                                          children: [
                                            ...
                                            if (item.pickupPoint!
                                              ...
                                              Image.asset(
                                                  ...
                                                  .onTap(() {
                                                commonLaunchUrl(
                                                    'tel:${item.pickupPoint!.contactNumber}');
                                              }),
                                          ],
                                        ),
                                      ],
                                        ...
                                        if (item.deliveryDatetime != null)
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              4.height,
                                              Text(
                                                  '${language.at} ${printDate(item.deliveryDatetime!)}',
                                                  style: secondaryTextStyle()),
                                              16.height,
                                            ],
                                          ),
                                          ...
                                          children: [
                                            ...
                                            if (item.deliveryPoint!
                                              ...
                                              Image.asset(
                                                  ...
                                                  .onTap(() {
                                                commonLaunchUrl(
                                                    'tel:${item.deliveryPoint!.contactNumber}');
                                              }),
                                          ],
                                        ),
                                      ],
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        AppButton(
                                          ...
                                          onTap: () {
                                            OrderTrackingScreen(orderData: item)
                                                .launch(context);
                                          },
                                        ).visible(
                                            item.status == ORDER_DEPARTED ||
                              ...
                              onTap: () {
                                OrderDetailScreen(orderId: item.id.validate())
                                    .launch(context,
                                        pageRouteAnimation:
